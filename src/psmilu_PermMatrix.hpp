...
/// \file psmilu_PermMatrix.hpp
/// \brief Permutation matrix/mapping
/// \authors Qiao,

#ifndef _PSMILU_PERMUTATIONMATRIX_HPP
#define _PSMILU_PERMUTATIONMATRIX_HPP
...
class BiPermMatrix : public PermMatrix<IndexType> {
 ...
 public:
  ...
  inline void make_eye() {
    psmilu_assert(_p.size() == _p_inv.size(), "nonmatching sizes");
    _base::make_eye();
