...
#ifndef _HIF_NSPFILTER_HPP
#define _HIF_NSPFILTER_HPP
...
/// \class NspFilter
/// \brief filter attached to \ref HIF for filtering null space components
/// \ingroup itr
///
