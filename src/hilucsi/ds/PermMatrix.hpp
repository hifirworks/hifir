...
/*!
 * \file hilucsi/ds/PermMatrix.hpp
...
#ifndef _HILUCSI_DS_PERMUTATIONMATRIX_HPP
#define _HILUCSI_DS_PERMUTATIONMATRIX_HPP
...
class BiPermMatrix : public PermMatrix<IndexType> {
 ...
 public:
  ...
  inline void make_eye() {
    hilucsi_assert(_p.size() == _p_inv.size(), "nonmatching sizes");
    _base::make_eye();
...
#endif  // _HILUCSI_DS_PERMUTATION_HPP
