...
/*!
 * \file hilucsi/arch/mkl_trsv.hpp
...
#ifndef _HILUCSI_ARCH_MKLTRSV_HPP
...
// NOTE: customized for HILUCSI, we only use unit diagonal CRS, in addition,
...
class MKL_SpTrSolver {
 ...
 protected:
  ...
  inline void _solve_upper(const double *x, double *y) const {
    ...
    hilucsi_error_if(solve_status != SPARSE_STATUS_SUCCESS,
                     "MKL spblas returned error %s",
...
#endif  // _HILUCSI_ARCH_MKLTRSV_HPP
