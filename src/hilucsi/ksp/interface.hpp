...
#ifndef _HILUCSI_KSP_INTERFACE_HPP
#define _HILUCSI_KSP_INTERFACE_HPP
...
class KSPSolver {
 public:
  ...
  virtual void        set_restart_or_cycle(const int) {
    hilucsi_warning("this solver does not support restart or truncated cycle!");
  }
...
#endif  // _HILUCSI_KSP_INTERFACE_HPP
